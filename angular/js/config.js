    ...
    .config(
        ['$controllerProvider', '$compileProvider', '$filterProvider', '$provide',
            function($controllerProvider, $compileProvider, $filterProvider, $provide) {
                ...
                app.locations = ['Singapore', 'Malaysia'];
                ...
                app.Servicefeatures = [{
                    "feature": "Prosthetic Make-Up"
                }, {
                    "feature": "Bridal Make-Up"
                }, {
                    "feature": "Event Make-Up"
                }, {
                    "feature": "Studio Make-Up"
                }];
                app.Shopfeatures = [{
                    "feature": "Prosthetic Make-Up"
                }, {
                ...
                app.Rentalfeatures = [{
                    "feature": "Registrant must be at least 18 years old"
                }, {
                    "feature": "Free AromaEase 5ml essential oil"
                }, {
                    "feature": "Goodie bag for the first 5000 participants"
                }, {
