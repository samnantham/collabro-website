'use strict';
app.controller('ViewProductCtrl', ['$scope', '$modal', '$document', '$state', '$timeout', 'webServices', 'utility', '$rootScope', '$stateParams', function($scope, $modal, $document, $state, $timeout, webServices, utility, $rootScope, $stateParams) {
