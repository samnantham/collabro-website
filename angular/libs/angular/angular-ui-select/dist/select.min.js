...
! function() {
    ...
    void 0 === angular.element.prototype.querySelectorAll && (angular.element.prototype.querySelectorAll = function(e) {
        ...
        function r() {
            (g.resetSearchInput || void 0 === g.resetSearchInput && a.resetSearchInput) && (g.search = f, g.selected && g.items.length && !g.multiple && (g.activeIndex = g.items.indexOf(g.selected)))
        }
        ...
        function o(t) {
            ...
            switch (t) {
                case e.DOWN:
                    !g.open && g.multiple ? g.activate(!1, !0) : g.activeIndex < g.items.length - 1 && g.activeIndex++;
                    break;
                case e.UP:
                    !g.open && g.multiple ? g.activate(!1, !0) : (g.activeIndex > 0 || 0 === g.search.length && g.tagging.isActivated) && g.activeIndex--;
                    break;
                case e.TAB:
                    (!g.multiple || g.open) && g.select(g.items[g.activeIndex], !0);
                    break;
                case e.ENTER:
                    g.open ? g.select(g.items[g.activeIndex]) : g.activate(!1, !0);
                    break;
                case e.ESC:
                    g.close();
                    break;
        ...
        function u(t) {
            function c() {
                switch (t) {
                    case e.LEFT:
                        return ~g.activeMatchIndex ? o : n;
                    case e.RIGHT:
                        return ~g.activeMatchIndex && a !== n ? r : (g.activate(), !1);
                    case e.BACKSPACE:
                        return ~g.activeMatchIndex ? (g.removeChoice(a), o) : n;
                    case e.DELETE:
                        return ~g.activeMatchIndex ? (g.removeChoice(g.activeMatchIndex), a) : !1
                }
            }
            var l = p(v[0]),
                i = g.selected.length,
                ...
                r = g.activeMatchIndex + 1,
                o = g.activeMatchIndex - 1,
                u = a;
            return l > 0 || g.search.length && t == e.RIGHT ? !1 : (g.close(), u = c(), g.activeMatchIndex = g.selected.length && u !== !1 ? Math.min(n, Math.max(s, u)) : -1, !0)
        }

        function d(e, t) {
            for (var c = angular.copy(e), l = -1, i = 0; i < c.length; i++)
                if (void 0 === g.tagging.fct) c[i] + " " + g.taggingLabel === t && (l = i);
                else {
                    var s = c[i];
        ...
        function h() {
            ...
            var l = t[g.activeIndex],
                i = l.offsetTop + l.clientHeight - e[0].scrollTop,
                s = e[0].offsetHeight;
            i > s ? e[0].scrollTop += i - s : i < l.clientHeight && (g.isGrouped && 0 === g.activeIndex ? e[0].scrollTop = 0 : e[0].scrollTop -= l.clientHeight - i)
        }
        var g = this,
            f = "";
        g.placeholder = void 0, g.search = f, g.activeIndex = 0, g.activeMatchIndex = -1, g.items = [], g.selected = void 0, g.open = !1, g.focus = !1, g.focusser = void 0, g.disabled = void 0, g.searchEnabled = void 0, g.resetSearchInput = void 0, g.refreshDelay = void 0, g.multiple = !1, g.disableChoiceExpression = void 0, g.tagging = {
            isActivated: !1,
            fct: void 0
        }, g.taggingTokens = {
            isActivated: !1,
            tokens: void 0
        }, g.lockChoiceExpression = void 0, g.closeOnSelect = !0, g.clickTriggeredSelect = !1, g.$filter = i, g.isEmpty = function() {
            return angular.isUndefined(g.selected) || null === g.selected || "" === g.selected
        };
        var v = c.querySelectorAll("input.ui-select-search");
        if (1 !== v.length) throw n("searchInput", "Expected 1 input.ui-select-search but got '{0}'.", v.length);
        g.activate = function(e, t) {
            g.disabled || g.open || (t || r(), g.focusser.prop("disabled", !0), g.open = !0, g.activeMatchIndex = -1, g.activeIndex = g.activeIndex >= g.items.length ? 0 : g.activeIndex, -1 === g.activeIndex && g.taggingLabel !== !1 && (g.activeIndex = 0), l(function() {
                g.search = e || g.search, v[0].focus()
            }))
        }, g.findGroupByName = function(e) {
            return g.groups && g.groups.filter(function(t) {
                return t.name === e
            })[0]
        }, g.parseRepeatAttr = function(e, c) {
            function l(e) {
                g.groups = [], angular.forEach(e, function(e) {
                    var l = t.$eval(c),
                        i = angular.isFunction(l) ? l(e) : e[l],
                        s = g.findGroupByName(i);
                    s ? s.items.push(e) : g.groups.push({
                        name: i,
                        items: [e]
                    })
                }), g.items = [], g.groups.forEach(function(e) {
                    g.items = g.items.concat(e.items)
                })
            }
            ...
            var a = c ? l : i;
            g.parserResult = s.parse(e), g.isGrouped = !!c, g.itemProperty = g.parserResult.itemName, t.$watchCollection(g.parserResult.source, function(e) {
                if (void 0 === e || null === e) g.items = [];
                else {
                    if (!angular.isArray(e)) throw n("items", "Expected an array but got '{0}'.", e);
                    if (g.multiple) {
                        var t = e.filter(function(e) {
                            return g.selected.indexOf(e) < 0
                        });
                        a(t)
                    } else a(e);
                    g.ngModel.$modelValue = null
                }
            }), g.multiple && t.$watchCollection("$select.selected", function(e) {
                var c = g.parserResult.source(t);
                if (e.length) {
                    if (void 0 !== c) {
        ...
        g.refresh = function(e) {
            void 0 !== e && (m && l.cancel(m), m = l(function() {
                t.$eval(e)
            }, g.refreshDelay))
        }, g.setActiveItem = function(e) {
            g.activeIndex = g.items.indexOf(e)
        }, g.isActive = function(e) {
            if (!g.open) return !1;
            var t = g.items.indexOf(e[g.itemProperty]),
                c = t === g.activeIndex;
            return !c || 0 > t && g.taggingLabel !== !1 || 0 > t && g.taggingLabel === !1 ? !1 : (c && !angular.isUndefined(g.onHighlightCallback) && e.$eval(g.onHighlightCallback), c)
        }, g.isDisabled = function(e) {
            if (g.open) {
                var t, c = g.items.indexOf(e[g.itemProperty]),
                    l = !1;
                return c >= 0 && !angular.isUndefined(g.disableChoiceExpression) && (t = g.items[c], l = !!e.$eval(g.disableChoiceExpression), t._uiSelectChoiceDisabled = l), l
            }
        }, g.select = function(e, c, l) {
            if (void 0 === e || !e._uiSelectChoiceDisabled) {
                if (!g.items && !g.search) return;
                if (!e || !e._uiSelectChoiceDisabled) {
                    if (g.tagging.isActivated) {
                        if (g.taggingLabel === !1)
                            if (g.activeIndex < 0) {
                                if (e = void 0 !== g.tagging.fct ? g.tagging.fct(g.search) : g.search, angular.equals(g.items[0], e)) return
                            } else e = g.items[g.activeIndex];
                        else if (0 === g.activeIndex) {
                            if (void 0 === e) return;
                            e = void 0 !== g.tagging.fct ? g.tagging.fct(g.search) : e.replace(g.taggingLabel, "")
                        }
                        if (g.selected && g.selected.filter(function(t) {
                                return angular.equals(t, e)
                            }).length > 0) return g.close(c), void 0
                    }
                    var i = {};
                    i[g.parserResult.itemName] = e, g.onSelectCallback(t, {
                        $item: e,
                        $model: g.parserResult.modelMapper(t, i)
                    }), g.multiple ? (g.selected.push(e), g.sizeSearchInput()) : g.selected = e, (!g.multiple || g.closeOnSelect) && g.close(c), l && "click" === l.type && (g.clickTriggeredSelect = !0)
                }
            }
        }, g.close = function(e) {
            g.open && (r(), g.open = !1, g.multiple || l(function() {
                g.focusser.prop("disabled", !1), e || g.focusser[0].focus()
            }, 0, !1))
        }, g.toggle = function(e) {
            g.open ? g.close() : g.activate(), e.preventDefault(), e.stopPropagation()
        }, g.isLocked = function(e, t) {
            var c, l = g.selected[t];
            return l && !angular.isUndefined(g.lockChoiceExpression) && (c = !!e.$eval(g.lockChoiceExpression), l._uiSelectChoiceLocked = c), c
        }, g.removeChoice = function(e) {
            var c = g.selected[e];
            if (!c._uiSelectChoiceLocked) {
                var l = {};
                l[g.parserResult.itemName] = c, g.selected.splice(e, 1), g.activeMatchIndex = -1, g.sizeSearchInput(), g.onRemoveCallback(t, {
                    $item: c,
                    $model: g.parserResult.modelMapper(t, l)
                })
            }
        }, g.getPlaceholder = function() {
            return g.multiple && g.selected.length ? void 0 : g.placeholder
        };
        var $;
        g.sizeSearchInput = function() {
            var e = v[0],
                c = v.parent().parent()[0];
            v.css("width", "10px");
            var i = function() {
                var t = c.clientWidth - e.offsetLeft - 10;
                50 > t && (t = c.clientWidth), v.css("width", t + "px")
            };
            l(function() {
                0 !== c.clientWidth || $ ? $ || i() : $ = t.$watch(function() {
                    return c.clientWidth
                }, function(e) {
                    0 !== e && (i(), $(), $ = null)
                })
            }, 0, !1)
        }, v.on("keydown", function(c) {
            var l = c.which;
            t.$apply(function() {
                var t = !1;
                if (g.multiple && e.isHorizontalMovement(l) && (t = u(l)), !t && (g.items.length > 0 || g.tagging.isActivated) && (t = o(l), g.taggingTokens.isActivated))
                    for (var i = 0; i < g.taggingTokens.tokens.length; i++) g.taggingTokens.tokens[i] === e.MAP[c.keyCode] && g.search.length > 0 && (g.select(null, !0), v.triggerHandler("tagged"));
                t && l != e.TAB && (c.preventDefault(), c.stopPropagation())
            }), e.isVerticalMovement(l) && g.items.length > 0 && h()
        }), v.on("keyup", function(c) {
            if (e.isVerticalMovement(c.which) || t.$evalAsync(function() {
                    g.activeIndex = g.taggingLabel === !1 ? -1 : 0
                }), g.tagging.isActivated && g.search.length > 0) {
                ...
                var l, i, s, n, a = angular.copy(g.items),
                    r = angular.copy(g.items),
                    o = !1,
                    u = -1;
                if (void 0 !== g.tagging.fct) {
                    if (s = g.$filter("filter")(a, {
                            isTag: !0
                        }), s.length > 0 && (n = s[0]), a.length > 0 && n && (o = !0, a = a.slice(1, a.length), r = r.slice(1, r.length)), l = g.tagging.fct(g.search), l.isTag = !0, r.filter(function(e) {
                            return angular.equals(e, g.tagging.fct(g.search))
                        }).length > 0) return
                } else {
                    if (s = g.$filter("filter")(a, function(e) {
                            return e.match(g.taggingLabel)
                        }), s.length > 0 && (n = s[0]), i = a[0], void 0 !== i && a.length > 0 && n && (o = !0, a = a.slice(1, a.length), r = r.slice(1, r.length)), l = g.search + " " + g.taggingLabel, d(g.selected, g.search) > -1) return;
                    if (r.filter(function(e) {
                            return e.toUpperCase() === g.search.toUpperCase()
                        }).length > 0) return o && (a = r, t.$evalAsync(function() {
                        g.activeIndex = 0, g.items = a
                    })), void 0;
                    if (g.selected.filter(function(e) {
                            return e.toUpperCase() === g.search.toUpperCase()
                        }).length > 0) return o && (g.items = r.slice(1, r.length)), void 0
                }
                o && (u = d(g.selected, l)), u > -1 ? a = a.slice(u + 1, a.length - 1) : (a = [], a.push(l), a = a.concat(r)), t.$evalAsync(function() {
                    g.activeIndex = 0, g.items = a
                })
            }
        }), v.on("tagged", function() {
            l(function() {
                r()
            })
        }), v.on("blur", function() {
            ...
            v.off("keyup keydown tagged blur")
        })
        ...
        return {
            ...
            link: function(n, a, r, o, u) {
                function d(e) {
                    var t = !1;
                    t = window.jQuery ? window.jQuery.contains(a[0], e.target) : a[0].contains(e.target), t || p.clickTriggeredSelect || (p.close(), n.$digest()), p.clickTriggeredSelect = !1
                }
                var p = o[0],
                    h = o[1],
                ...
                r.tabindex && r.$observe("tabindex", function(e) {
                    ...
                    void 0 !== r.tagging && void 0 !== r.taggingLabel && (p.taggingLabel = "false" === r.taggingLabel ? !1 : void 0 !== r.taggingLabel ? r.taggingLabel : "(new)")
